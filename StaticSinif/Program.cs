...
namespace StaticSinif
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Calisan calisan1 = new Calisan("Samet","Demirel","Yazılım");
            Console.WriteLine("Çalışan Sayısı: {0}", Calisan.CalisanSayisi);
            Calisan calisan2 = new Calisan("Samet", "Demirel", "Yazılım");
            Calisan calisan3 = new Calisan("Samet", "Demirel", "Yazılım");
            Calisan calisan4 = new Calisan("Samet", "Demirel", "Yazılım");
            Console.WriteLine("Çalışan Sayısı: {0}", Calisan.CalisanSayisi);
